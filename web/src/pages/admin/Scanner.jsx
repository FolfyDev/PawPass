...
export default function Scanner() {
  ...
  const handle = async (value) => {
    ...
    try {
      ...
      if (mode !== 'checkin') {
        const p = await api.post('/api/badges/print', { value });
          ...
          {result?.registration && (
            <div className="stub">
              ...
              <div className="stub-foot row">
                <button className="btn sm" onClick={() => api.post('/api/badges/print', { code: result.registration.code }).catch((e) => setError(e.message))}>Reprint badge</button>
